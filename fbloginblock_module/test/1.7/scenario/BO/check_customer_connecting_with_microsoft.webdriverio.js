...
describe('Check customer connecting with microsoft in back office', function() {
    ...
    describe('Access to the customer page', function (done) {
        ...
        it('should filter the list by address email', function (done) {
            this.client
                ...
                .setValue(this.selector.customer_address_email_input, 'prestotests@outlook.com')
                .call(done);
        });
        ...
        it('should check new microsoft customer', function (done) {
            this.client
                .waitForExist(this.selector.microsoft.microsoft_logo_customer_page, 90000)
                .moveToObject(this.selector.microsoft.microsoft_logo_customer_page)
                .getAttribute(this.selector.microsoft.microsoft_logo_customer_page, 'title').then(function (title) {
                should(title).be.equal('Microsoft');
            })
                .getAttribute(this.selector.microsoft.microsoft_logo_customer_page, 'alt').then(function (alt) {
    ...
    //     it('should check the microsoft customer connection ', function (done) {
    //         global.fctname = this.test.title;
    //         this.client
    //             .url('https://' + URL)
    ...
    //             .setValue(this.selector.loginFO, 'prestotests@outlook.com')
