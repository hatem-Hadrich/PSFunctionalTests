...
describe('Check customer connecting with amazon in back office', function() {
    ...
    describe('Access to the customer page', function (done) {
        ...
        it('should filter the list by address email', function (done) {
            this.client
                ...
                .setValue(this.selector.customer_address_email_input, 'prestotests+amazon@gmail.com')
                .call(done);
        });
        ...
        it('should check new amazon customer', function (done) {
            this.client
                .waitForExist(this.selector.amazon.amazon_logo_customer_page, 90000)
                .moveToObject(this.selector.amazon.amazon_logo_customer_page)
                .getAttribute(this.selector.amazon.amazon_logo_customer_page, 'title').then(function (title) {
                should(title).be.equal('Amazon');
            })
                .getAttribute(this.selector.amazon.amazon_logo_customer_page, 'alt').then(function (alt) {
    ...
    //     it('should check the amazon customer connection ', function (done) {
    //         global.fctname = this.test.title;
    //         this.client
    //             .url('https://' + URL)
    ...
    //             .setValue(this.selector.loginFO, 'prestotests+amazon@gmail.com')
