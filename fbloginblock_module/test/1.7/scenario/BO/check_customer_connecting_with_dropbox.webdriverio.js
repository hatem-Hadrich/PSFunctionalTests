...
describe('Check customer connecting with dropbox in back office', function() {
    ...
    describe('Access to the customer page', function (done) {
        ...
        it('should filter the list by address email', function (done) {
            this.client
                ...
                .setValue(this.selector.customer_address_email_input, 'prestotests+dropbox@gmail.com')
                .call(done);
        });
        ...
        it('should check new dropbox customer', function (done) {
            this.client
                .waitForExist(this.selector.dropbox.dropbox_logo_customer_page, 90000)
                .moveToObject(this.selector.dropbox.dropbox_logo_customer_page)
                .getAttribute(this.selector.dropbox.dropbox_logo_customer_page, 'title').then(function (title) {
                should(title).be.equal('Dropbox');
            })
                .getAttribute(this.selector.dropbox.dropbox_logo_customer_page, 'alt').then(function (alt) {
