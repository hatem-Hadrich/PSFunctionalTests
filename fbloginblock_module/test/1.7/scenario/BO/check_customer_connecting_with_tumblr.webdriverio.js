...
describe('Check customer connecting with tumblr in back office', function() {
    ...
    describe('Access to the customer page', function (done) {
        ...
        it('should filter the list by address email', function (done) {
            this.client
                ...
                .setValue(this.selector.customer_address_email_input, 'prestotests+tumblr@gmail.com')
                .call(done);
        });
        ...
        it('should check new tumblr customer', function (done) {
            this.client
                .waitForExist(this.selector.tumblr.tumblr_logo_customer_page, 90000)
                .moveToObject(this.selector.tumblr.tumblr_logo_customer_page)
                .getAttribute(this.selector.tumblr.tumblr_logo_customer_page, 'title').then(function (title) {
                should(title).be.equal('Tumblr');
            })
                .getAttribute(this.selector.tumblr.tumblr_logo_customer_page, 'alt').then(function (alt) {
