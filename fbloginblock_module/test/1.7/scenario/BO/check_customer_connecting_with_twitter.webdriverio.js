...
describe('Check customer connecting with twitter in back office', function() {
    ...
    describe('Access to the customer page', function (done) {
        ...
        it('should check new twitter customer', function (done) {
            this.client
                .waitForExist(this.selector.twitter.twitter_logo_customer_page, 90000)
                .moveToObject(this.selector.twitter.twitter_logo_customer_page)
                .getAttribute(this.selector.twitter.twitter_logo_customer_page, 'title').then(function (title) {
                should(title).be.equal('Twitter');
            })
                .getAttribute(this.selector.twitter.twitter_logo_customer_page, 'alt').then(function (alt) {
